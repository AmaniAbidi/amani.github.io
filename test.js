(function() {
    describe("Account", function() {
        beforeEach(() => {
            account = new Account(55555);
        });

        describe("getNumber", function () {
            it("returns accounts number", function () {
                    assert.equal(account.getNumber(), 55555);
                });
        });
        ...
        describe("deposit", function () {
            describe("the amount is more than 0", function() {
            ...
            describe("the amount is less than 0", function() {
        ...
        describe("withdraw", function () {
            describe("the amount is more than the balance", function() {
    ...
    describe("SavingsAccount", function() {
        beforeEach(() => {
            savingsAccount = new SavingsAccount(0.09, 55555);
        });

        describe("setInterest", function () {
            it("sets account interest", function () {
                savingsAccount.setInterest(0.14);
                assert.equal(savingsAccount.getInterest(), 0.14);
            });
        });
        ...
        describe("endOfMonth", function () {
            it("print details of savings account", function () {
                savingsAccount.deposit(100);
                savingsAccount.addInterest()
                assert.equal(savingsAccount.endOfMonth(), 'Interest added SavingsAccount 55555: balance: 100.180081 interest: 0.09');
            });
        });
    ...
    describe("CheckingAccount", function() {
        beforeEach(() => {
            checkingAccount = new CheckingAccount(1000, 55555);
        });
        ...
        describe("withdraw", function () {
            ...
            describe("the given amount is less than or equal 0", function() {
            ...
            describe("the given amount is valid", function() {
                it("decrement account balance by given amount", function () {
        ...
        describe("endOfMonth", function () {
            describe("the balance is below zero", function() {
                it("print warning details of checking account", function () {
                    checkingAccount.deposit(120);
                    checkingAccount.withdraw(300);
                    assert.equal(checkingAccount.endOfMonth(), 'Warning, low balance CheckingAccount 5555: balance: -180 overdraft limit: 1000');
                });
            });

            describe("the balance is above zero", function() {
    ...
    describe("Bank", function() {
        ...
        describe("addCheckingAccount", function () {
            it("adds a checking account, and returns number of accounts", function () {
                assert.equal(bank.addCheckingAccount(1000, 23), 1);
            });
        });
        ...
        describe("accountReport", function () {
            it("print details of each existing account", function () {
                bank.addCheckingAccount(1000, 23);
                bank.addAccount(124);
                bank.addSavingsAccount(0.02, 1243);
                assert.equal(bank.accountReport(), "Checking Account 23: balance 0: overdraft limit 1000\nAccount 124: balance 0\nSavings Account 1243: balance 0: intreset 0.02");
            });
        });
    });
})();
