describe("filter", function () {
    it("a String method that accepts an array of string arguments, and returns the filtered string without thoses string inputs",
        function () {
...
describe("bubbleSort", function () {
    it("an Array method, returns the array sorted using bubble sort",
        function () {
